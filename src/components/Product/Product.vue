  ...
  <v-container>
    <section class="product mt-3 elevation-10">
      <v-layout row wrap>
        ...
        <v-flex xs12 lg6>
          <div class="prdocut_info">
            <h5 class="product_title display-1 mb-3 mt-3">{{ product.title }}</h5>
            <p class="product_category title">
              <span class="product_title">Vendor: </span>{{ product.vendor.charAt(0).toUpperCase() + product.vendor.slice(1)}}
            </p>
            ...
            <p class="title">
              <span class="product_title">Material: </span>{{ product.material.charAt(0).toUpperCase() + product.material.slice(1)}}
            </p>
